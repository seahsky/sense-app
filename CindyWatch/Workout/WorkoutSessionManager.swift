...
final class WorkoutSessionManager: NSObject {
    ...
    /// APIs for *recording* sub-activities since watchOS 9, and Cindy already knows
    ...
    static let movementMetadataKey = "com.cindyapp.movement"
    static let movementNameMetadataKey = "com.cindyapp.movementName"
    static let roundMetadataKey = "com.cindyapp.round"
