...
/// Streams wrist motion into `CindyKit`'s ``RepDetectionEngine`` and reports the
/// repetitions it finds.
///
/// This is the only file in the project that imports Core Motion. Everything that
/// decides *whether something is a rep* lives in `CindyKit` as pure, testable
...
final class MotionRepSensor {
    ...
    private let motionQueue: OperationQueue = {
        ...
        queue.name = "com.cindyapp.motion-rep-sensor"
