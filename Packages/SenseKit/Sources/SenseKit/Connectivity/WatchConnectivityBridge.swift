...
public protocol SenseConnectivityDelegate: AnyObject {
...
public final class WatchConnectivityBridge: NSObject {
    ...
    /// `SenseConnectivityDelegate`'s contract.
    public static let liveContextDidUpdateNotification = Notification.Name("SenseKit.WatchConnectivityBridge.liveContextDidUpdate")

    public weak var delegate: SenseConnectivityDelegate?
